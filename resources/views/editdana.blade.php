...
<div class="row no-gutters mt-4 ">
    ...
    <div class="col-md-10 mt-2 p-5 pl-5">
        <h3><i class="fas fa-user-plus mr-2"></i>  EDIT RINCIAN </h3> <hr class="bg-secondary">
            ...
            <form method="post" action="/danadesa/edit/{{$desa->id}}">
            @method('patch')
            @csrf
            ...
            <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="tanggatanggall" aria-describedby="tanggalhelp" name="tanggal"value="{{ $desa->tanggal }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('pemasukan') is-invalid @enderror" id="pemasukan" aria-describedby="pemasukan help" name="pemasukan" value="{{ $desa->pemasukan }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('sumber') is-invalid @enderror" id="sumber" aria-describedby="sumberhelp" name="sumber" >
                    <small id="sumberhelp" class="form-text text-muted">sumber.</small>
                </div>

                <div class="form-group">
                    <label for="pengeluaran"> Pengeluaran </label>
                    <input type="text" class="form-control @error('pengeluaran') is-invalid @enderror" id="pengeluaran" aria-describedby="pengeluaranhelp" name="pengeluaran" >
                    <small id="pemasukanhelp" class="form-text text-muted">pengeluaran.</small>
                </div>

                <div class="form-group">
                    <label for="penggunaan"> Penggunaan </label>
                    <input type="text" class="form-control @error('penggunaan') is-invalid @enderror" id="penggunaan" aria-describedby="pengeluaranhelp" name="penggunaan" >
                    <small id="pemasukanhelp" class="form-text text-muted">penggunaan.</small>
                </div>

                <div class="form-group">
                    <label for="total"> Total </label>
                    <input type="text" class="form-control @error('total') is-invalid @enderror" id="total" aria-describedby="totalhelp" name="total">
